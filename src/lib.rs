...
use std::fs;
use std::io::Read;
use tracing_subscriber::{filter::EnvFilter, FmtSubscriber}; // 0.3.1
...
async fn handle_cron_event(metadata: Metadata) -> Result<(), Error> {
    ...
    // TODO: Funny to code this way. If do this, do better error thing/Don't ignore it with _
